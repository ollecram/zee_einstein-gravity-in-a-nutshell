...
That Newton's is a ***central field***  means that by taking the origin of one's coordinate system in the center, then force and position vectors are collinear (parallel). 




<!--stackedit_data:
eyJoaXN0b3J5IjpbLTQxMjYwNTQ1NV19
-->