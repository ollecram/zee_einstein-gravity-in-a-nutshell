...
These two vectors do determine a plane. By choosing the origin of our coordinate axes $(\mathbf{i}, \mathbf{j}, \mathbf{k})$ in the field center,  the $\mathbf{k}$ axis orthogonal to the $\mathbf{j} $ plane of motion, s ystem of coordinates with  system
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNzYwMDMwMzE3XX0=
-->