...
It all relates to a couple of more First of all, Let see how such symmetry argument can be construed from very basic assumptions.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTYxMDM0ODQyMl19
-->