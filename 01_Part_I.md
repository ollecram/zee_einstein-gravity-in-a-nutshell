...
An often repeated statement says that *due to a simple "symmetry argument"* the points occupied in the course of time by a particle subject to a central force field are all contained in a plane. Let see how such symmetry argument can be construed from very basic assumptions.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTExMDkzNjY3Nl19
-->