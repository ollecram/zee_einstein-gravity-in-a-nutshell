...
It all relates to a couple of more basic asumptions, namely> First of all, Let see how such symmetry argument can be construed from very basic assumptions.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTI0ODE3ODA4MV19
-->