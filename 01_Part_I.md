...
$$ \ddot{x} = \ddot{r} \cos{\theta} - 2 \dot{r}\sin{\theta} \,\dot{\theta} -  r \cos{\theta} \,\dot{\theta}^2 -  r \sin{\theta} \,\ddot{\theta} = -k \frac{x}{r^}$$
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNjY3NTA1NzU1LDExNzAzMzE2MTUsLTEyMj
