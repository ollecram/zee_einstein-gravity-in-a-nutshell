...
These two vectors do determine a plane. By choosing the origin of our coordinate axes $(\mathbf{i}, \mathbf{j}, \mathbf{k})$ in the field center and the $\mathbf{k}$ axis orthogonal to the plane of mots ystem of coordinates with  system
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTczNTMzNzEwXX0=
-->