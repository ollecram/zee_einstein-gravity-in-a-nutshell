...
$$ \ddot{x} = \ddot{r} \cos{\theta} - 2 \dot{r}\sin{\theta} \,\dot{\theta} -  r \cos{\theta} \,\dot{\theta}^2 -  r \sin{\theta} \,\ddot{\theta} = -k \frac{x}{}$$
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEyMjA0NzI2MzMsLTEzNDQ2NjkyMTksLT
E1NDc5OTcxNTQsMTI2NDk5MzgwNiwtNDA1MTc0MzAyLC0xMjkz
NTYyMjYwLDYyMzA3OTEwMSwxMzY1NTM3NDI1LDQ3NzA1OTA0Mi
w1Nzc5MDUxMjNdfQ==
-->