...
$ds(\phi)$. Note that this expression must fulfill two requirements:
 ...
 1. The general expression for the path length differential on the sphere, with longitude coordinate $\phi$ and latitude coordinate  is: $dl^2=R^2()$;
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTIxMTY3MzE0NjJdfQ==
-->