...
In order derive the analogous of Snell's law on the sphere let us accurately state our problem:
 ...
 1. Our coordinate system on the sphere is determined by the poles $p$ and $P$ of the $C_{[p,P]}$ circle (not necessarily a great  
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEzNTkwMjk3ODVdfQ==
-->