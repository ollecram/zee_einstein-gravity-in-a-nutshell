...
Following the exercise's question, let assume the ant be slower on the northern hemisphere, in which case the equator plays the same role of the air.  
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTcwNTU2MjYyXX0=
-->