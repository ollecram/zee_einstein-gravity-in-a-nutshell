...
Note that stated in this form the law can be more easily interpreted as saying that light $\sin \theta$ hence the light path projection parallel to the 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbODcxNzk0OTQzXX0=
-->