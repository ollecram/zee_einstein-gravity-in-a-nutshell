...
where the function $ds(\phi)$ gives the incremental path lenBy solving the minimum problem we expect to obtain a relation analogous to Snell's law, thus involving 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTQ2MzQ0MDA2OF19
-->