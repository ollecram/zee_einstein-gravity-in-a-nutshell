...
The answer being: 
the shortest path on a sphere between two points is the shortest of the two circular segments in which the two points divide the unique circle of radius $R$ containing those points. mum 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjEwODk2MzEyM119
-->