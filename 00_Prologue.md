...
The whole argument can be simplified by assuming that the external and internal face of the bowl can be separated and the space in between inflated to make the hemisphere into a sphere whose he equator mapping what was the border of the former double sided hemisphere. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTkxMDIwNTQwNl19
-->