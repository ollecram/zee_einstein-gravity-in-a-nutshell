...
[REF3](http://vixra.org/pdf/1404.0016v1.pdf)
 ...
 #### 3.1 Sphere geodesic
 At this point we need a mathematical digression to derive the equation of a geodesic connecting two points in spherical coordinates. The length of the path over a sphere's surface between twIn order to apply the well known method of variations calculus of variation to minimize the length of the path s  
 

<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE0NzMxMjI1MjZdfQ==
-->