...
Following the exercise's question, let assume the ant be slower on the northern hemisphere, in which case the equator plays a .  
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjA0NTczOTc1Ml19
-->