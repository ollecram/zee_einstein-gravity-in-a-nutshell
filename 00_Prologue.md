...
$$\Leftrightarrow C^2 + C^2 \sin^2\!\theta\dot{\phi}^2 = \sin^4\!\theta\dot{\phi}^2 \Leftrightarrow C^2 + \sin^2\!\theta (C^2 - \sin^2\!\theta)\dot{\phi}^2 = 0$$
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNTYyNDM4MDRdfQ==
-->