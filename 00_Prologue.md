...
Following the exercise's question, let assume the ant be slower on the northern hemisphere, in which case the equator plays the same .  
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTA2NjU4MjU2Nl19
-->