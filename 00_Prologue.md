...
The whole argument can be simplified by assuming that the external and internal face of the bowl can be separated and the space in between inflated to make the hemisphere into the external e-sided surface (sphere) whose equatorial circle maps the border of the former double sided hemisphere. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTc3MzM5ODY0OV19
-->