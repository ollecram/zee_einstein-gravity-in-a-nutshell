...
Note that stated in this form the law can be more easily interpreted as saying that light $\sin \theta$ hence the light path project
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE4MjcyMDQxMTBdfQ==
-->