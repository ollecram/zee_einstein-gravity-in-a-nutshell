...
where the function $ds(\phi)$ gives the incremental path length associated to By solving the minimum problem we expect to obtain a relation analogous to Snell's law, thus involving 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTY1MDMwNTg0NF19
-->