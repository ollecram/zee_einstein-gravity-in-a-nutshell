...
The answer being: 
the shortest path on a sphere between two points is the shortest of the two circular segments in which the two points divide tunique circle of radius $R$ maximum 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbODExMTY4NTE3XX0=
-->