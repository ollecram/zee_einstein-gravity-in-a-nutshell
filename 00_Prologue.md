...
Given that the inside and outside paths are identical and separately each one the shortest path on the corresponding side of the surface



<!--stackedit_data:
eyJoaXN0b3J5IjpbNzM2NjEyMjI0XX0=
-->