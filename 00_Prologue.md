...
The whole argument can be rephrased by assuming that the external and internal face of the bowl can be separated and the space in between inflated to make the hemisphere into a sphere, the equator mapping what was the border of the former bowl
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE2ODQ2ODY3OTJdfQ==
-->