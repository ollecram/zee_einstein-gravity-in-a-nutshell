...
The value of $x$ determines the relative length of segments which light travels at differeto make the total time $t(x) = t_{a}(x) + t_{w}(x)$ to be the minimum
### 2
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTIwNTA0OTcxMTBdfQ==
-->