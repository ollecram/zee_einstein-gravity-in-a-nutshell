...
where the function $ds(\phi)$ gives the incremental By solving the minimum problem we expect to obtain a relation analogous to Snell's law, thus involving 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTgzMDA0NjM3MF19
-->