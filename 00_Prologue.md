...
Clearly the circle $C_{[p,P]}$ has a role in the problem which is analogous to that of the air-water interface in applicatio
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNjI3NTExNjcyXX0=
-->