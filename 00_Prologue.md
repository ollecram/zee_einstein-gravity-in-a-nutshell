...
### 1 Snell's law
Let be given two points>: $P=(a,b)$ in the upper (air) zone and a point $R=(A,B)$ in the lower (water) zone. Assume without loss of generality the air-water interface to lie parallel to the $x$ axis.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTcyNzk0MTUzXX0=
-->