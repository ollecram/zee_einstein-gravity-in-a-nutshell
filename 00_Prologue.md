...
In order derive the analogous of Snell's law on the sphere let us accurately state our problem:
 ...
 8. The shortest-length paths $\widehat{PQ}$ and between two points $P$ and $Q$ is a portion of the unique geodesic (great circle) defined by the two points; 
 9. meridian containing the two points;
 10. of a on the sphere is the shortest of the two  

<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE2OTY2NzYzNDZdfQ==
-->