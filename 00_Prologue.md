...
Note that stated in this form the law can be more easily interpreted as saying that light $\sin \theta$ hence the light path projection parallel 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTU4NDg4NTE2NV19
-->