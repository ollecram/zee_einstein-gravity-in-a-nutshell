...
Let say the bowl is half a sphere of radius $R$ and assume the ant being located at latitude $\theta$ from the south pole, on the greenwhich meridian meridian  
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTg0NjA0NDAzLDE2MTU5NDkyMDZdfQ==
-->