...
$ds(\phi)$. Note that this expression must fulfill two requirements:
 ...
 1. The general expression for the path length differential on the sphere, with longitude coordinate $\phi$ and latitude coordinate $\theta$ is: $dl^2=R^2(d\theta^2+\cos^2 \!\theta d\phi^2)$;
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTY4NDU0NDQ4MiwtMTYyNDExMTUwOV19
-->