...
Note that stated in this form the law can be more easily interpreted as saying that $\sin \theta$ -- the light path projection parallel to the interface -- must be greater where the light speed is greater.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE2NzEwNzEzMjYsLTE2MDIzMTY3MjgsMT
