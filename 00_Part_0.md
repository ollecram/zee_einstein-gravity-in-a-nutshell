...
Thus finally
$$\dot{\phi} = \frac{C}{\sin\!\theta\sqrt{\sin^2\!\theta - C^2} }$$ and we are now left with computing the integral of the right hand side with respect to $\theta$.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTExOTg0NjQwMDYsNjQxNTQ4NjUyXX0=
-->