...
This is because the infinitesimal squared path length on a sphere is $ds^{2} = R^{2} (d\theta^{2} + d\phi^{2})$. In order to to the     
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTQzNjEwOTM4NSwtNTk0NDI2Nzg2LDE2MT
U5NDkyMDZdfQ==
-->