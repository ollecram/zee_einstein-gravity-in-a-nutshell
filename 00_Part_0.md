...
where the function $ds(\phi)$ gives the incremental lenBy solving the minimum problem we expect to obtain a relation analogous to Snell's law, thus involving 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMzQ0NDc2OTMxLC0xNjI0MTExNTA5XX0=
-->