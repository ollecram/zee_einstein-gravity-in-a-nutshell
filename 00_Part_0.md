...
$$\Leftrightarrow \frac{C^2}{\dot{\phi}^2} = \sin^2\!\theta (C^2 - \sin^2\!\theta)\dot{\phi}^2 = 0 \Leftrightarrow \dot{\phi}^2 = \frac{C^2}{\sin^2\!\theta - C^2 }$$
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTA1Mjc5OTI0Myw2NDE1NDg2NTJdfQ==
-->