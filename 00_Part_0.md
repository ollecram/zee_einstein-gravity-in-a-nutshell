...
The value of $x$ determines the relative length of the two segments along which light travels at different speeds, thus determining the total time $t(x) = t_{a}(x) + t_{w}(x)$.  to be the minimum
### 2
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE5ODkxODMwODksMTk5NTQxOTAyNywxNj
U5NTU1MDcyXX0=
-->