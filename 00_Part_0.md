...
Given that the inside and outside paths are identical and separately each one is the shortest path on the corresponding side of the surface there is nothing that can be gained.  gain 



<!--stackedit_data:
eyJoaXN0b3J5IjpbMTk3ODUwNTMzNCwtNTk0NDI2Nzg2LDE2MT
U5NDkyMDZdfQ==
-->