...
By solving the minimum problem we expect to obtain a relation involving the angles $\theta_{a}$ and $\theta_{w}$ that the light rays make with the meridian intersecting the interface $C_{[N,S]}$ circle at a point $Q$.    

<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE4MDY5MzQ1NTMsLTE2MjQxMTE1MDldfQ
==
-->