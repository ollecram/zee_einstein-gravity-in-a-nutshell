...
With the above specifications the problem can be solved by finding the longitude of $Q$ ($0 = \phi_{P} \leq \phi_{Q} \leq \phi_{R}$) that minimizes the total light time $

<!--stackedit_data:
eyJoaXN0b3J5IjpbODUyNzMyNTc2LDQxMTYzODgyOF19
-->