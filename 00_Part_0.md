...
With the above specifications the problem can be solved by finding the longitude of $Q$ satisfying  $0 = \phi_{P} \leq \phi_{Q} \leq \phi_{R}$

<!--stackedit_data:
eyJoaXN0b3J5IjpbMTU3MDExMTc3MCw0MTE2Mzg4MjhdfQ==
-->